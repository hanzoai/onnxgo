...
Native GPU inference (CUDA, TensorRT, CoreML, DirectML) for production AI workloads.
Forked from [yalue/onnxruntime_go](https://github.com/yalue/onnxruntime_go) — March 29, 2026.


A few example applications using this library can be found in the
[`onnxruntime_go_examples` repository](https://github.com/hanzoai/onnxgo-examples).
